...
export class UserComponent implements OnInit{
  ...
  sourceListModel: string[] = [];
  destinationListModel: string[] = [];
  ...
  generatePassword(length: number = 10) {
    ...
    this.form.controls['password'].patchValue(password);
    this.form.controls['confirmpassword'].patchValue(password);
  }
