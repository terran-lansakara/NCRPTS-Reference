...
export class SupplierComponent implements OnInit{
  ...
  initialize(){
    ...
    this.categoryService.getAllList().then((categories => {
      ...
      this.allCategories = [...this.categories]; // Save original categories on component initialization
    }))
  ...
  leftAll():void{
    for(let supplies of this.selectedSupplies) this.categories.push(supplies.category);
  ...
  fillForm(supplier: Supplier) {
    ...
    console.log("Before" + this.categories.length);
    ...
    console.log("After" + this.categories.length);
